...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/causal-conv1d-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/causal-conv1d-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add causal-conv1d
# for installing globally
pixi global install causal-conv1d
```
...
It is possible to list all of the versions of `causal-conv1d` available on your platform:
...
```
pixi search causal-conv1d --channel conda-forge
```
